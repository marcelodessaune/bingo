...
function checkBingo(card) {
    ...
    if (isBingo) {
        ...
        winnerElement.textContent = 'Parabéns ' + winnerName + '! Você ganhou.';
...
document.getElementById('add-card-button').addEventListener('click', function () {
    var cardName = prompt('Digite o nome do participante:');
    if (!cardName) {
        return;
    }
...
document.getElementById('play-button').addEventListener('click', function () {
    ...
    interval = setInterval(function () {
        ...
        if (numbers.length === 75) {
            ...
            noWinnerElement.textContent = 'Nenhum jogador venceu..';
